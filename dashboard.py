...
">{p['name']}</a>"""
    ...
    html = (
        ...
        "<style>\n"
        ":root{--bg:linear-gradient(160deg,#ffb3b3 0%,#ff7070 50%,#e83232 100%);--surface:rgba(255,255,255,.7);--surface2:rgba(255,255,255,.55);--accent:#4f7ef7;--accent2:#6366f1;--red:#e05c5c;--emerald:#16a37a;--amber:#d97706;--purple:#7c3aed;--muted:#64748b;--text:#0f172a;--text2:#475569;--border:#e2e8f0;--shadow:0 1px 3px rgba(0,0,0,.07),0 1px 2px rgba(0,0,0,.04);}\n"
