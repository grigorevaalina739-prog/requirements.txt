...
">{p['name']}</a>"""
    ...
    html = (
        ...
        "<style>\n"
        ":root{--navy:#0f1629;--accent:#4f8ef7;--red:#e05c5c;--emerald:#34c98a;--amber:#f0a832;--purple:#8b78f0;--muted:#7d8fa8;--border:rgba(148,163,184,.12);--card-bg:rgba(255,255,255,.03);}\n"
        "*{box-sizing:border-box;margin:0;padding:0;}\n"
        "body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,sans-serif;background:#0f1629;color:#e8edf5;min-height:100vh;}\n"
        ...
        ".sidebar{padding:22px 16px 22px 0;border-left:1px solid rgba(148,163,184,.1);}\n"
        ...
        ".kpi:hover{transform:translateY(-3px);border-color:rgba(148,163,184,.2);box-shadow:0 8px 24px rgba(0,0,0,.25);}\n"
        ...
        ".prog-card{background:rgba(26,37,64,.8);border:1px solid rgba(148,163,184,.1);border-radius:14px;padding:18px 20px;margin-bottom:18px;}\n"
        ...
        ".att-card{background:rgba(26,37,64,.6);border:1px solid rgba(148,163,184,.08);border-radius:14px;padding:16px;margin-bottom:18px;}\n"
        ...
        ".ctrl-bar{background:rgba(26,37,64,.5);border:1px solid rgba(148,163,184,.1);border-radius:12px;padding:10px 14px;margin-bottom:14px;display:flex;flex-wrap:wrap;gap:8px;align-items:center;}\n"
        ...
        ".pill-active{background:#4f8ef7!important;color:white!important;border-color:#4f8ef7!important;}\n"
        ...
        ".tbl-wrap{background:#111e36;border:1px solid rgba(148,163,184,.1);border-radius:14px;overflow:hidden;}\n"
        ".tbl-wrap table{width:100%;border-collapse:collapse;}\n"
        ".tbl-wrap thead th{padding:10px 13px;font-size:10px;font-weight:700;color:#7d8fa8;text-transform:uppercase;letter-spacing:.08em;background:#0f1629;border-bottom:1px solid rgba(255,255,255,.08);white-space:nowrap;position:sticky;top:60px;z-index:10;}\n"
        ".task-row{border-bottom:1px solid rgba(148,163,184,.06);transition:background .1s;background:#111e36 !important;}\n"
        ".task-row:hover{background:#162040 !important;}\n"
        ".task-row td{padding:13px;vertical-align:middle;color:#d8e2f0 !important;}\n"
        ".act-btn{width:30px;height:30px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:13px;text-decoration:none;border:none;cursor:pointer;transition:all .15s;background:rgba(148,163,184,.08);}\n"
        ...
        ".dl-date{width:34px;height:34px;background:rgba(79,142,247,.12);border-radius:8px;display:flex;flex-direction:column;align-items:center;justify-content:center;flex-shrink:0;}\n"
        ...
        ".qa-btn{padding:8px 13px;border-radius:10px;font-size:12px;font-weight:500;text-decoration:none;border:1px solid rgba(148,163,184,.1);color:#a8bccc;background:rgba(26,37,64,.6);transition:all .15s;display:flex;align-items:center;gap:7px;margin-bottom:5px;}\n"
