...
ОПРЕДЕЛЕНИЕ ПРОЕКТА (обязательно):
Используй ключевые слова для определения проекта:
- "SC", "SC MINISO", "закуп", "товар", "SKU", "МДС", "поставщик", "заказ", "IP" → "SC MINISO"
- "борд", "Board", "стратегия", "встреча", "совет", "пакет", "POSM" → "Board Miniso"
- "сверка", "склад", "инвентаризация", "Мирада", "списание", "накладные" → "Сверка баз"
- Если из контекста непонятно → оставь project: ""
